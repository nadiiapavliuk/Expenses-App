...
//            if BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[key] == nil
//            {
//                BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[key] = 0.0
//            }
//
//            amountSpentArray.append(BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[key]!)
//
...
//        }
//
//        if BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[monthKey] == nil
//        {
//            BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[monthKey] = 0.0
//        }
//
//        // Store the new amount into the dictionary with the key being today's date (MM/dd/YYYY)
//        let newAmount = BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[key]! + num
//        BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[key] = newAmount
//
//        let newMonthAmount = BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[monthKey]! + num
//        BudgetVariables.budgets[BudgetVariables.currentIndex].amountSpentOnDate[monthKey] = newMonthAmount
//    }
//
